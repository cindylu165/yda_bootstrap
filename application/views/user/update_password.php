...
<div class="container">
  <div class="col-md-12">
    ...
    <form class="row g-3" action="<?php echo site_url($url); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
      ...
      <div class="col-12">
        ...
        <input class="form-control" type="password" id="password" name="password" required value="<?php echo ($password == '000000') ?'000000' : '';?>">
      </div>
    
      <div class="col-6">
        <label for="passwordNew" class="form-label">請輸入新密碼(密碼需包含英文字母大寫、英文字母小寫與數字並長度大於8)*</label>
        <input class="form-control" type="password" id="passwordNew" name="passwordNew" required>
      </div>

      <div class="col-6">
        <label for="passwordVerify" class="form-label">請再次輸入新密碼(密碼需包含英文字母大寫、英文字母小寫與數字並長度大於8)*</label>
        <input class="form-control" type="password" id="passwordVerify" name="passwordVerify" required>
      </div>
