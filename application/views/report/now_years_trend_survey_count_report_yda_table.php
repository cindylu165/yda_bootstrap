								...
								<tbody>
									<tr>
										...
										<?php } else { ?>
											...
											<td><?php $cnt = 5000;
												foreach ($nowYearsTrendSurveyCountReports as $i) {
											...
											<td style="text-align:left"><?php $cnt = "";
																		...
																		?></td>
											<?php if ($countyType == 'all') : ?>
												<td><a class="btn btn-info" href="<?php echo site_url('report/now_years_trend_survey_count_report_yda_table/' . $yearType . '/' . $monthType . '/' . $counties[$j]['no']); ?>">審核</a></td>
