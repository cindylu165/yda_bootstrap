		...
		<div class="card-body col-sm-12">
			...
			<div class="card-content">
				<form action="<?php echo site_url($url); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
					...
					<a class="btn btn-success" href="<?php echo site_url('export/organization_month_report_export/' . 'NowYearsTrendSurveyCountReport' . '/' . $yearType . '/' . $monthType); ?>">列印(下載EXCEL檔)</a><br /><br />
					...
					<?php if ($reportProcessesCounselorStatus == $reviewStatus['review_process_pass']) : ?>
						...
						<table class="table table-hover table-bordered align-middle text-center" style="border:2px grey solid;">
							...
							<tbody>
								<tr>
									<td><?php echo $nowYearsTrendSurveyCountReports ? $nowYearsTrendSurveyCountReports->already_working : null ?></td>
									<td><?php echo $nowYearsTrendSurveyCountReports ? $nowYearsTrendSurveyCountReports->already_attending_school : null ?></td>
									<td><?php echo $nowYearsTrendSurveyCountReports ? $nowYearsTrendSurveyCountReports->special_education_student : null ?></td>
									<td><?php echo $nowYearsTrendSurveyCountReports ? $nowYearsTrendSurveyCountReports->prepare_to_school : null ?></td>
									<td><?php echo $nowYearsTrendSurveyCountReports ? $nowYearsTrendSurveyCountReports->prepare_to_work : null ?></td>
									<td><?php echo $nowYearsTrendSurveyCountReports ? $nowYearsTrendSurveyCountReports->training : null ?></td>
									<td><?php echo $nowYearsTrendSurveyCountReports ? $nowYearsTrendSurveyCountReports->family_labor : null ?></td>
									<td><?php echo $nowYearsTrendSurveyCountReports ? $nowYearsTrendSurveyCountReports->health : null ?></td>
									<td><?php echo $nowYearsTrendSurveyCountReports ? $nowYearsTrendSurveyCountReports->no_plan : null ?></td>
									<td><?php echo $nowYearsTrendSurveyCountReports ? $nowYearsTrendSurveyCountReports->lost_contact : null ?></td>

									<td><?php echo $nowYearsTrendSurveyCountReports ? $nowYearsTrendSurveyCountReports->transfer_labor + $nowYearsTrendSurveyCountReports->transfer_other + $nowYearsTrendSurveyCountReports->pregnancy
												+ $nowYearsTrendSurveyCountReports->other : null ?></td>
									<td><?php echo $nowYearsTrendSurveyCountReports ? $nowYearsTrendSurveyCountReports->immigration + $nowYearsTrendSurveyCountReports->death + $nowYearsTrendSurveyCountReports->military : null ?></td>
									<td><?php echo $nowYearsTrendSurveyCountReports ? $nowYearsTrendSurveyCountReports->in_case : null ?></td>
									<td><?php echo $youthCount ? $youthCount : null ?></td>
									<td><?php echo $nowYearsTrendSurveyCountReports ? $nowYearsTrendSurveyCountReports->prepare_to_school + $nowYearsTrendSurveyCountReports->prepare_to_work + $nowYearsTrendSurveyCountReports->training + $nowYearsTrendSurveyCountReports->family_labor
												+ $nowYearsTrendSurveyCountReports->health + $nowYearsTrendSurveyCountReports->no_plan + $nowYearsTrendSurveyCountReports->lost_contact + $nowYearsTrendSurveyCountReports->transfer_labor + $nowYearsTrendSurveyCountReports->transfer_other + $nowYearsTrendSurveyCountReports->pregnancy
												+ $nowYearsTrendSurveyCountReports->other + $nowYearsTrendSurveyCountReports->immigration + $nowYearsTrendSurveyCountReports->death + $nowYearsTrendSurveyCountReports->military : null ?></td>
									<td><?php echo $nowYearsTrendSurveyCountReports ? $nowYearsTrendSurveyCountReports->prepare_to_school + $nowYearsTrendSurveyCountReports->prepare_to_work + $nowYearsTrendSurveyCountReports->training + $nowYearsTrendSurveyCountReports->family_labor
												+ $nowYearsTrendSurveyCountReports->health + $nowYearsTrendSurveyCountReports->no_plan + $nowYearsTrendSurveyCountReports->lost_contact + $nowYearsTrendSurveyCountReports->transfer_labor + $nowYearsTrendSurveyCountReports->transfer_other + $nowYearsTrendSurveyCountReports->pregnancy
												+ $nowYearsTrendSurveyCountReports->other : null ?></td>
									<td style="text-align:left"><?php echo $nowYearsTrendSurveyCountReports ? str_replace("\n", "<br/>", $nowYearsTrendSurveyCountReports->note) : null ?></td>
