<table class="surveyTypeHighSchoolTrack table table-hover text-center" style="border:2px grey solid;">
  ...
  <?php for ($j = 0; $j < count($counties); $j++) { ?>
    <tr>
      ...
      <?php else:?>
        ...
        <?php if ($countyType == 'all') :?>
          <td ><a class="btn btn-primary my-3" href="<?php echo site_url('report/' . $reviewPage . '/' . $yearType . '/' . $monthType . '/' . $counties[$j]['no']);?>">審核</a></td>
