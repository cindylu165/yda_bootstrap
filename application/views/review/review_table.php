...
<div class="container">
  <div class="row">
    <div class="card col s12">
      ...
      <h6 class="card-title text-center">等待批准清單</h6>
    ...
    if ($i['no'] == $value['status']) {
        echo $i['content'];
              ...
              <td>
                <a class="btn waves-effect blue lighten-1" href="<?php echo site_url($url . '/' . $value['no']); ?>">審核</a>
              </td>
            </tr>
            <?php }?>
          </tbody>
      ...
      <h6 class="card-title text-center">已批准清單</h6>
      <div class="card-content">
    ...
    if ($i['no'] == $value['status']) {
      ...
      <h6 class="card-title text-center">未批准清單</h6>
      <div class="card-content">
        <table class="highlight">
          <thead class="thead-dark">
            <tr>
