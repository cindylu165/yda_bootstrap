...
<div class="container">
  ...
  <div class="col-md-12">
    ...
    <br><h5 class="card-title text-center text-center">轉介單位基本資料</h5>
      <div class="row g-4">
        <!-- referralInstitution -->
        <div class="col">
    ...
    <br><h5 class="card-title text-center text-center">轉介單位的處遇概況</h5>
    ...
    <br><h5 class="card-title text-center">青少年基本資料</h5>
...
foreach ($counselIdentitys as $i) {
  ...
  <?php }?>
          ...
          <br><h5 class="card-title text-center">青少年主要需求</h5>
