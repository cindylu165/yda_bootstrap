        ...
        <div class="col-md-12 col-xs-12">
            <table class="table table-bordered">
              <thead class="thead-dark">
                <tr>
                  <th style="background-color:black;" scope="col" class="header">日期</th>
                  <th style="background-color:black;" scope="col" class="header">動向</th>
                  <th style="background-color:black;" scope="col" class="header">動向說明</th>
                </tr>
              </thead>
              <tbody>
